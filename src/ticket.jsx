...
function ticket(props) {
    ...
    console.log('rating', props.data.rating);


    return (
        <div className='tickets'>
            <main class="ticket-system">
                <div className='sucsses-message'><h5>Booking confirmed, [Client Name]! 🎉 We’re excited to have you with us. Safe travels!</h5></div>
                <div class="top">
                    <div class="printer" />
                </div>
